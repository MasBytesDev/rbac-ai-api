 ...
 * <p>
 * Maps to the "app_user" table and stores user details such as fullname,
 * email, password hash, and status. Includes lifecycle hooks and domain
 * methods to safely update user information while enforcing validation
...
public class AppUser extends BaseEntity{
     ...
     * Ensures that the user status is initialized to PENDING if not set.
     */
    @PrePersist
     ...
     * @throws IllegalArgumentException if the fullname is null, blank, or exceeds 100 characters
     */
     ...
     * @throws IllegalArgumentException if the password hash is null, blank, or exceeds 255 characters
     */
